...
int main(void) {
    ...
    while (1) {
        ...
        scrollBuffer32(scrollCols,/* USER CODE BEGIN Header */
            /**
              ******************************************************************************
              * @file           : main.c
            ...
            int main(void)
            {
              ...
              uint8_t scrollCols[256];
              int len;
              float temperatuur, luchtvochtigheid;
              char buf[512];
              ...
              while (1)
              {
                  ...
                  sprintf(buf, "    %s -- Temperatuur: %sC, Luchtvochtigheid: %s%% ", menuDag, tempStr, humStr);
                  buildScrollBufferFromString(buf, scrollCols, &len);
