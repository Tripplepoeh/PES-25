...
//     	 buzzer.zetUit();
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //knop.poll();
//	 	          if (knop.isIngedrukt()) {
//	 	             // HAL_UART_Transmit(&huart2, (uint8_t*)"Knop ingedrukt\r\n", 17, HAL_MAX_DELAY);
//
//	 	              //uint8_t knopBuffer[1] = { 0xA5 };
//	 	              //HAL_I2C_Slave_Transmit(&hi2c1, knopBuffer, 1, 100);  // gebruik een timeout
//	 	        	  //HAL_UART_Transmit(&huart2, (uint8_t*)"Buzzer AAN\r\n", 12, HAL_MAX_DELAY);
//	 	                  buzzer.zetAan();
//	 	              } else {
